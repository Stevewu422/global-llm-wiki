...
## 2026-07-30 — Repair six-hour preflight gates

- Classified the local Vault as the non-versioned authority when its optional
  Git metadata has no commit and zero tracked files; its safety is validated by
  the Vault contract, health, conflict, link, sensitive, backup, and readback
  gates instead of treating every Vault page as an unknown Git change.
- Moved confirmed generated Python bytecode to a recoverable local backup,
  ignored future bytecode, and added an AST-only Python syntax gate.
- Kept Git cleanliness mandatory for the portable shared clone and Hermes,
  including the explicit `REMOTE_PREFLIGHT_OK` completion marker.
...
- 2026-07-28 20:29:21: Hermes guarded sync exported public-safe Obsidian memory (58 files, 6 skipped, 34 link-sanitized files, 38 EOF-normalized files).

- 2026-07-29 02:29:27: Hermes guarded sync exported public-safe Obsidian memory (58 files, 6 skipped, 34 link-sanitized files, 38 EOF-normalized files).

- 2026-07-29 08:29:37: Hermes guarded sync exported public-safe Obsidian memory (58 files, 6 skipped, 34 link-sanitized files, 38 EOF-normalized files).

- 2026-07-29 14:29:44: Hermes guarded sync exported public-safe Obsidian memory (58 files, 6 skipped, 34 link-sanitized files, 38 EOF-normalized files).

- 2026-07-29 20:30:38: Hermes guarded sync exported public-safe Obsidian memory (58 files, 6 skipped, 34 link-sanitized files, 38 EOF-normalized files).

- 2026-07-30 02:31:08: Hermes guarded sync exported public-safe Obsidian memory (58 files, 6 skipped, 34 link-sanitized files, 38 EOF-normalized files).

- 2026-07-30 11:35:41: Hermes guarded sync exported public-safe Obsidian memory (58 files, 6 skipped, 34 link-sanitized files, 38 EOF-normalized files).

- 2026-07-30 13:31:46: Hermes guarded sync exported public-safe Obsidian memory (58 files, 2 skipped, 19 link-sanitized files, 33 EOF-normalized files).
