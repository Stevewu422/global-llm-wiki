...
- 完整原文：`90-Archive/Hermes-Builtin-Memory-Original-20260723-235622/USER.original.md` 与 `MEMORY.original.md`
...
- USER.original.md：108 条
- MEMORY.original.md：35 条
- 合计：143 条

## 使用规则

1. 高频强约束先看 `00-System/USER.md` 与 `00-System/MEMORY.md`。
2. 需要历史细节时按本迁移地图进入主题页。
3. 主题页内容来自旧内置记忆，涉及实时后台、行情、余额、订单、配置时必须现场回读。
4. 后续每次使用后，把确认仍有效的事实精炼回项目页/Playbook；过期事实标注或移入 Archive。
