...
local_repo: /root/global-llm-wiki
...
- 本地 Git 仓库：`/root/global-llm-wiki`
...
- Public Obsidian Snapshot：Obsidian Vault Home
- LLM Wiki Pattern：llm-wiki-pattern
- Implementations Comparison：llm-wiki-implementations
